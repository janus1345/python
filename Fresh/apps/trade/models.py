...
class OrderInfo(models.Model):
    ...
    pay_status = models.CharField(choices=ORDER_STATUS,default='playing',max_length=30, verbose_name='订单状态')
    post_script = models.CharField(max_length=200, verbose_name='订单留言')
    order_mount = models.FloatField(default=0.0, blank=True, verbose_name='订单金额')
