# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-11-19 09:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('success', '成功'), ('cancel', '取消'), ('cancel', '待支付')], default='playing', max_length=30, verbose_name='订单状态')),
                ('post_script', models.CharField(max_length=200, verbose_name='订单留言')),
                ('order_mount', models.FloatField(blank=True, default=0.0, verbose_name='订单金额')),
